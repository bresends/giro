...
import { LogOut, LogIn, Car, Clock, AlertCircle, UserPlus } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Guarita - Controle de Viaturas</h1>
                  ...
                  {recentMovements.map((movement) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="text-right font-mono">
                          {movement.arrivalKm ? (
                            new Intl.NumberFormat("pt-BR").format(movement.arrivalKm)
                          ) : (
                        ...
                        <TableCell className="text-right font-mono">
                          {distance !== null ? (
                            <span className="text-green-700 dark:text-green-400">
                              {new Intl.NumberFormat("pt-BR").format(distance)} km
                            </span>
                          ) : (
                            <span className="text-orange-600 font-bold">—</span>
                          )}
